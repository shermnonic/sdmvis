...
=========================================================================*/
// .NAME vtkGlyph3D_3 - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkGlyph3D_3 is a filter that copies a geometric representation (called
...
#ifndef __vtkGlyph3D_3_h
#define __vtkGlyph3D_3_h
...
#define VTK_SCALE_X_BY_VECTOR 4
#define VTK_SCALE_Y_BY_VECTOR 5
#define VTK_SCALE_Z_BY_VECTOR 6
...
class /*VTK_GRAPHICS_EXPORT*/ vtkGlyph3D_3 : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkGlyph3D_3,vtkPolyDataAlgorithm);
...
private:
  vtkGlyph3D_3(const vtkGlyph3D_3&);  // Not implemented.
  void operator=(const vtkGlyph3D_3&);  // Not implemented.
};

// Description:
// Return the method of scaling as a descriptive character string.
inline const char *vtkGlyph3D_3::GetScaleModeAsString(void)
{
...
inline const char *vtkGlyph3D_3::GetColorModeAsString(void)
{
...
inline const char *vtkGlyph3D_3::GetVectorModeAsString(void)
{
...
inline const char *vtkGlyph3D_3::GetIndexModeAsString(void)
{
